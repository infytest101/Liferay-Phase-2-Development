...
import hotelmanagement.services.model.CustomerModel;
...
/**
 * The base model implementation for the Customer service. Represents a row in the &quot;Hotel_Customer&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class CustomerModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "Hotel_Customer";
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"age", Types.INTEGER}, {"desc_", Types.VARCHAR}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table Hotel_Customer (customerId INTEGER not null primary key,firstName VARCHAR(75) null,middleName VARCHAR(75) null,lastName VARCHAR(75) null,email VARCHAR(75) null,mobile VARCHAR(75) null,age INTEGER,desc_ VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table Hotel_Customer";

	public static final String ORDER_BY_JPQL =
		" ORDER BY customer.customerId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Hotel_Customer.customerId ASC";
	...
	static {
		...
		attributeGetterFunctions.put("desc", Customer::getDesc);
		attributeSetterBiConsumers.put(
			"desc", (BiConsumer<Customer, String>)Customer::setDesc);
	...
	public CacheModel<Customer> toCacheModel() {
		...
		customerCacheModel.desc = getDesc();

		String desc = customerCacheModel.desc;

		if ((desc != null) && (desc.length() == 0)) {
			customerCacheModel.desc = null;
		}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("desc_", _desc);
	}
