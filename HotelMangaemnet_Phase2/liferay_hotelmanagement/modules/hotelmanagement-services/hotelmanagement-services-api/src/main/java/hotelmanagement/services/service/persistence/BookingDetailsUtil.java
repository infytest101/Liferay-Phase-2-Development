...
public class BookingDetailsUtil {
	...
	public static BookingDetails remove(long bookingDetailsId)
		throws hotelmanagement.services.exception.
			NoSuchBookingDetailsException {
