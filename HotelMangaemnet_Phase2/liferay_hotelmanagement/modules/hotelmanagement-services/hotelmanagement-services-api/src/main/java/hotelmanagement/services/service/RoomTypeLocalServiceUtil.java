 ...
 * <code>hotelmanagement.services.service.impl.RoomTypeLocalServiceImpl</code> and
...
public class RoomTypeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>hotelmanagement.services.service.impl.RoomTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static RoomType createRoomType(int roomTypeId) {
	 ...
	 */
	public static RoomType deleteRoomType(int roomTypeId)
		throws PortalException {
	...
	public static RoomType fetchRoomType(int roomTypeId) {
	 ...
	 * @throws PortalException if a room type with the primary key could not be found
	 */
	public static RoomType getRoomType(int roomTypeId) throws PortalException {
