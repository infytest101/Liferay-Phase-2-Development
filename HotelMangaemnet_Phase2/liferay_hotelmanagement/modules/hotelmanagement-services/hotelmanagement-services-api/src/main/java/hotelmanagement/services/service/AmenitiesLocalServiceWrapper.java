...
public class AmenitiesLocalServiceWrapper
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Amenities addAmenities(
		hotelmanagement.services.model.Amenities amenities) {
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Amenities createAmenities(
		int amenitiesId) {
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Amenities deleteAmenities(
		hotelmanagement.services.model.Amenities amenities) {
	...
	@Override
	public hotelmanagement.services.model.Amenities fetchAmenities(
		int amenitiesId) {
	...
	@Override
	public java.util.List<hotelmanagement.services.model.Amenities>
		findByIsWifiAvailable(Boolean isWifiAvailable) {

		return _amenitiesLocalService.findByIsWifiAvailable(isWifiAvailable);
	}
	...
	public java.util.List<hotelmanagement.services.model.Amenities>
		...
		return _amenitiesLocalService.findByIsWifiTvGeyserAvailable(
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Amenities getAmenities(
			int amenitiesId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public java.util.List<hotelmanagement.services.model.Amenities>
		getAmenitieses(int start, int end) {
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Amenities updateAmenities(
		hotelmanagement.services.model.Amenities amenities) {
