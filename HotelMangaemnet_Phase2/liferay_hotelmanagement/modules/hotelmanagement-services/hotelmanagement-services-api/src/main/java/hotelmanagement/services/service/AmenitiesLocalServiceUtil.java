 ...
 * <code>hotelmanagement.services.service.impl.AmenitiesLocalServiceImpl</code> and
...
public class AmenitiesLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>hotelmanagement.services.service.impl.AmenitiesLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Amenities> findByIsWifiAvailable(
		...
		return getService().findByIsWifiAvailable(isWifiAvailable);
	}
	...
	public static List<Amenities> findByIsWifiTvGeyserAvailable(
		...
		return getService().findByIsWifiTvGeyserAvailable(
