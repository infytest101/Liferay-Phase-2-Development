...
public interface CustomerLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>ROOMSERVICES.service.impl.CustomerLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the customer local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CustomerLocalServiceUtil} if injection and service tracking are not available.
	 */
