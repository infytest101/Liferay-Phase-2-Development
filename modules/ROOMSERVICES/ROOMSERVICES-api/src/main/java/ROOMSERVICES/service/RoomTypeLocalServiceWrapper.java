...
public class RoomTypeLocalServiceWrapper
	 ...
	 */
	@Override
	public ROOMSERVICES.model.RoomType addRoomType(
	...
	@Override
	public java.util.List<ROOMSERVICES.model.RoomType> findByroomType(
			String RoomType)
		throws com.liferay.portal.kernel.exception.SystemException {

		return _roomTypeLocalService.findByroomType(RoomType);
	}
	 ...
	 */
	@Override
	public java.util.List<ROOMSERVICES.model.RoomType> getRoomTypes(
		int start, int end) {
	 ...
	 */
	@Override
	public ROOMSERVICES.model.RoomType updateRoomType(
		ROOMSERVICES.model.RoomType roomType) {
