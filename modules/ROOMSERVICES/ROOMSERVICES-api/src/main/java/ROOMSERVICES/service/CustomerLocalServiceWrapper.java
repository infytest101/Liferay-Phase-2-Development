...
public class CustomerLocalServiceWrapper
	 ...
	 */
	@Override
	public ROOMSERVICES.model.Customer addCustomer(
		ROOMSERVICES.model.Customer customer) {
	 ...
	 */
	@Override
	public ROOMSERVICES.model.Customer deleteCustomer(
		ROOMSERVICES.model.Customer customer) {
	 ...
	 */
	@Override
	public java.util.List<ROOMSERVICES.model.Customer> getCustomers(
		int start, int end) {
	 ...
	 */
	@Override
	public ROOMSERVICES.model.Customer updateCustomer(
		ROOMSERVICES.model.Customer customer) {
