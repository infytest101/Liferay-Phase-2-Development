...
public interface RoomTypeLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>hotelmanagement.services.service.impl.RoomTypeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the room type local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RoomTypeLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public RoomType createRoomType(int roomTypeId);
	...
	public RoomType deleteRoomType(int roomTypeId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RoomType fetchRoomType(int roomTypeId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RoomType getRoomType(int roomTypeId) throws PortalException;
