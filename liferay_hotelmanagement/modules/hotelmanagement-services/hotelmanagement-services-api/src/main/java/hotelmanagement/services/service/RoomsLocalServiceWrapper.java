...
public class RoomsLocalServiceWrapper
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Rooms addRooms(
		hotelmanagement.services.model.Rooms rooms) {
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Rooms createRooms(int roomId) {
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Rooms deleteRooms(int roomId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Rooms deleteRooms(
		hotelmanagement.services.model.Rooms rooms) {
	...
	@Override
	public hotelmanagement.services.model.Rooms fetchRooms(int roomId) {
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Rooms getRooms(int roomId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<hotelmanagement.services.model.Rooms> getRoomses(
		int start, int end) {
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Rooms updateRooms(
		hotelmanagement.services.model.Rooms rooms) {
