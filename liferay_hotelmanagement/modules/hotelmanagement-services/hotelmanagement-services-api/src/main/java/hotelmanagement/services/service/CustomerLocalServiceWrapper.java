...
public class CustomerLocalServiceWrapper
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Customer addCustomer(
		hotelmanagement.services.model.Customer customer) {
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Customer createCustomer(
		int customerId) {
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Customer deleteCustomer(
		hotelmanagement.services.model.Customer customer) {
	...
	@Override
	public hotelmanagement.services.model.Customer fetchCustomer(
		int customerId) {
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Customer getCustomer(int customerId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<hotelmanagement.services.model.Customer> getCustomers(
		int start, int end) {
	 ...
	 */
	@Override
	public hotelmanagement.services.model.Customer updateCustomer(
		hotelmanagement.services.model.Customer customer) {
