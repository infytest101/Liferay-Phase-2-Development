...
public class AmenitiesUtil {
	 ...
	 */
	public static List<Amenities> findByIsWifiTvGeyserAvailable(
		Boolean isWifiAvailable, Boolean isTVAvailable,
		Boolean isGeyserAvailable) {

		return getPersistence().findByIsWifiTvGeyserAvailable(
	 ...
	 */
	public static Amenities findByIsWifiTvGeyserAvailable_First(
			Boolean isWifiAvailable, Boolean isTVAvailable,
			Boolean isGeyserAvailable,
			OrderByComparator<Amenities> orderByComparator)
		throws hotelmanagement.services.exception.NoSuchAmenitiesException {

		return getPersistence().findByIsWifiTvGeyserAvailable_First(
			isWifiAvailable, isTVAvailable, isGeyserAvailable,
			orderByComparator);
	}
	 ...
	 */
	public static Amenities fetchByIsWifiTvGeyserAvailable_First(
		Boolean isWifiAvailable, Boolean isTVAvailable,
		Boolean isGeyserAvailable,
		OrderByComparator<Amenities> orderByComparator) {

		return getPersistence().fetchByIsWifiTvGeyserAvailable_First(
			isWifiAvailable, isTVAvailable, isGeyserAvailable,
			orderByComparator);
	}
	 ...
	 * @throws NoSuchAmenitiesException if a matching amenities could not be found
	 */
	public static Amenities findByIsWifiTvGeyserAvailable_Last(
			Boolean isWifiAvailable, Boolean isTVAvailable,
			Boolean isGeyserAvailable,
			OrderByComparator<Amenities> orderByComparator)
		throws hotelmanagement.services.exception.NoSuchAmenitiesException {

		return getPersistence().findByIsWifiTvGeyserAvailable_Last(
			isWifiAvailable, isTVAvailable, isGeyserAvailable,
			orderByComparator);
	}
	 ...
	 */
	public static Amenities fetchByIsWifiTvGeyserAvailable_Last(
		Boolean isWifiAvailable, Boolean isTVAvailable,
		Boolean isGeyserAvailable,
		OrderByComparator<Amenities> orderByComparator) {

		return getPersistence().fetchByIsWifiTvGeyserAvailable_Last(
			isWifiAvailable, isTVAvailable, isGeyserAvailable,
			orderByComparator);
	}
	 ...
	 */
	public static Amenities[] findByIsWifiTvGeyserAvailable_PrevAndNext(
			int amenitiesId, Boolean isWifiAvailable, Boolean isTVAvailable,
			Boolean isGeyserAvailable,
			OrderByComparator<Amenities> orderByComparator)
		throws hotelmanagement.services.exception.NoSuchAmenitiesException {

		return getPersistence().findByIsWifiTvGeyserAvailable_PrevAndNext(
			amenitiesId, isWifiAvailable, isTVAvailable, isGeyserAvailable,
			orderByComparator);
	}
	 ...
	 * @param isGeyserAvailable the is geyser available
	 */
	public static void removeByIsWifiTvGeyserAvailable(
		Boolean isWifiAvailable, Boolean isTVAvailable,
		Boolean isGeyserAvailable) {

		getPersistence().removeByIsWifiTvGeyserAvailable(
			isWifiAvailable, isTVAvailable, isGeyserAvailable);
	}
	 ...
	 */
	public static int countByIsWifiTvGeyserAvailable(
		Boolean isWifiAvailable, Boolean isTVAvailable,
		Boolean isGeyserAvailable) {

		return getPersistence().countByIsWifiTvGeyserAvailable(
			isWifiAvailable, isTVAvailable, isGeyserAvailable);
	}
