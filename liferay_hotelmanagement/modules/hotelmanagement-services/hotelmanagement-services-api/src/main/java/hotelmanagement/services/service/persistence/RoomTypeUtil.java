...
public class RoomTypeUtil {
	...
	public static RoomType findByRoomType_First(
		...
		throws hotelmanagement.services.exception.NoSuchRoomTypeException {
	 ...
	 */
	public static RoomType create(int roomTypeId) {
	 ...
	 * @throws NoSuchRoomTypeException if a room type with the primary key could not be found
	 */
	public static RoomType remove(int roomTypeId)
		throws hotelmanagement.services.exception.NoSuchRoomTypeException {
	 ...
	 * @throws NoSuchRoomTypeException if a room type with the primary key could not be found
	 */
	public static RoomType findByPrimaryKey(int roomTypeId)
		throws hotelmanagement.services.exception.NoSuchRoomTypeException {
	 ...
	 */
	public static RoomType fetchByPrimaryKey(int roomTypeId) {
